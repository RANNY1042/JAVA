package Study_20240320;
	...
	public class linkedlist {
		...
		public static void main(String[] args) {
			...
			//Arrays.asList()메서드는 인자로 전달한 값들을 가진 List객체를 생성하여 반환
			
			List<String> list2 = Arrays.asList("북경","상해");		
			list.addAll(list2);
			
			
			//toArray()메서드는 List객체를 Object타입의 일반 배열로 변환하여 반환한다. 
			
			Object obj[] = list.toArray();
			System.out.println("24: " +Arrays.toString(obj));
			
		
			//toArray()메서드의 인지로 특정 타입의 배열을 전달하면 해당 타입의 배열로 List를 변환하여 반환
