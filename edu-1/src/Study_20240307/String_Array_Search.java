package Study_20240307;
	...
	*/
	...
	public class String_Array_Search {
		...
		public static void main(String[] args) {
			...
			String key = "포도";
			int resultIndex = linearSearch(data, key); //linearSearch작성
			 ...
			 * 교재 109~113
			 */
			resultIndex = binarySearch(data, key); //binarySearch작성 (binarySearch 알고리즘 훈련)
